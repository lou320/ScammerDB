...
from .models import Scammer, ScammerName, ScammerPhoneNumber, ScammerEmail, ScammerWebsite, ScammerImage, Tag, ScammerPaymentAccount
...
class PhoneNumberWidget(MultiWidget):
    def __init__(self, attrs=None):
        attrs = attrs or {}
        widgets = [
            Select(attrs={'class': 'form-select'}, choices=COUNTRY_CODE_CHOICES),
            TextInput(attrs={'class': 'form-control', 'placeholder': _('Phone Number')})
        ]
